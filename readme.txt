...
This plugin allows you to create a simple timeline and a series of events that you can assign to that timeline.
...
1. Upload the `epoch-timelines` folder to the `/wp-content/plugins/` directory
